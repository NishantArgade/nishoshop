...
router
  .route("/admin/users")
  .get(isAuthenticateUser, autorizeRoles("admin"), getAllUsers);

router
  .route("/admin/user/:id")
  .get(isAuthenticateUser, autorizeRoles("admin"), getSingleUser)
  .put(isAuthenticateUser, autorizeRoles("admin"), updateUserRole)
  .delete(isAuthenticateUser, autorizeRoles("admin"), deleteUser);
